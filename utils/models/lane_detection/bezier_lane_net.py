...
class BezierLaneNet(BezierBaseNet):
    ...
    def __init__(self,
        ...
        self.colornet = MODELS.from_dict(colornet_cfg)
    ...
    def forward(self, x):
        ...
        colored_input, color_residual = self.colornet(x)
        
        x = self.backbone(colored_input)
        features = x['out']
        ...
        return {'color_residual': color_residual,
