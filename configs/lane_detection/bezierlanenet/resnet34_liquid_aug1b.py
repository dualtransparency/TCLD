...
train = dict(
    exp_name='resnet34_bezierlanenet_liquid-aug2'+now,
    workers=8,
    batch_size=96,
    checkpoint=None,
    # Device args
...
###########################################################################################################
test = dict(
    exp_name='resnet34_bezierlanenet_liquid-aug2',
    workers=0,
    batch_size=1,
    checkpoint='/home/wxy/exps/Bezier_liquid/resnet34_bezierlanenet_liquid-aug220231024_19_clok/model.pt',
    # Device args
    device='cuda',
